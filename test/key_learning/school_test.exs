defmodule KeyLearning.SchoolTest do
  ...
  describe "courses" do
    ...
    @valid_attrs %{image_path: "some image_path", nome: "some nome"}
    @update_attrs %{image_path: "some updated image_path", nome: "some updated nome"}
    @invalid_attrs %{image_path: nil, nome: nil}
    ...
    test "update_course/2 with valid data updates the course" do
      ...
      assert course.nome == "some updated nome"
    end
